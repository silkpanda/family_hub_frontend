...
// Provides API functions for managing shared lists and their items.
...
const assignList = (listId, userIds) => api.patch(`${API_URL_LIST}/${listId}/assign`, { userIds }).then(res => res.data);
